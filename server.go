...
func (s *Server) registerRoutes() {
	...
	s.mux.HandleFunc("PATCH /users/{id}/role", s.middlewareAuth(s.middlewareRequireRole(RoleAdmin, s.handleUpdateUserRole)))
	s.mux.HandleFunc("GET /users", s.middlewareAuth(s.middlewareRequireRole(RoleAdmin, s.handleGetAllUsers)))
	...
	s.mux.HandleFunc("POST /items", s.middlewareAuth(s.middlewareRequireRole(RoleManager, s.handleCreateItem)))
	s.mux.HandleFunc("GET /items/{id}", s.middlewareAuth(s.handleGetItemFromID))
	s.mux.HandleFunc("DELETE /items/{id}", s.middlewareAuth(s.middlewareRequireRole(RoleManager, s.handleDeleteItem)))
	s.mux.HandleFunc("PATCH /items/{id}", s.middlewareAuth(s.middlewareRequireRole(RoleManager, s.handleUpdateItem)))

	s.mux.HandleFunc("POST /locations", s.middlewareAuth(s.middlewareRequireRole(RoleManager, s.handleCreateLocation)))
	...
	s.mux.HandleFunc("PATCH /locations/{id}", s.middlewareAuth(s.middlewareRequireRole(RoleManager, s.handleUpdateLocation)))
	s.mux.HandleFunc("DELETE /locations/{id}", s.middlewareAuth(s.middlewareRequireRole(RoleManager, s.handleDeleteLocation)))
	...
	s.mux.HandleFunc("POST /stock/receive", s.middlewareAuth(s.middlewareRequireRole(RoleManager, s.handleReceiveStock)))
	s.mux.HandleFunc("POST /stock/move", s.middlewareAuth(s.handleMoveStock))

	s.mux.HandleFunc("GET /movements", s.middlewareAuth(s.middlewareRequireRole(RoleManager, s.handleGetMovementHistory)))
	s.mux.HandleFunc("GET /movements/item/{id}", s.middlewareAuth(s.middlewareRequireRole(RoleManager, s.handleGetItemMovementHistory)))
}
